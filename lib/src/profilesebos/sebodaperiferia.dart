...
class PerfilPeriferia extends StatefulWidget {
  const PerfilPeriferia({super.key});

  @override
  State<PerfilPeriferia> createState() => _PerfilPeriferiaState();
}

class _PerfilPeriferiaState extends State<PerfilPeriferia> {
  @override
            ...
            children: [
              ...
              Positioned(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(image: AssetImage('assets/images/perfilperiferia.jpg'), fit: BoxFit.cover)
                ),
              )),
              Positioned( left: 172, top: 133,
                child: Column(
                  ...
                  children: [
                  const Text('Sebo da Periferia', style: TextStyle(
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    child: const Padding(
                      ...
                      child: SelectableText('O Sebo da Periferia é onde pode ser encontrado livros usados e novos. Trabalhamos principalmente com literatura paraense e livros em geral.', 
                      style: TextStyle(
                  ...
                  Container(
                    ...
                    child: const Padding(
                      padding: EdgeInsets.only(top: 10, bottom: 10, left: 20, right: 20),
                      child: SelectableText('R. Triunvirato, 450 - Cidade Velha, Belém - PA, 66020-645', 
                      style: TextStyle(
                        color: Color(0XFF245B60),
                        fontFamily: 'DMSans-Bold', fontSize: 14,
                      )),
